...
export const optimizedLesson26Comprehensive: Lesson = {
  ...
  content: {
    ...
    sections: [
      {
        ...
        content: "Anatomy → Physiology → Pathophysiology → Types → Risk Stratification",
        mediaType: 'image'
      },
      {
        id: 'unit-2-overview', 
        title: "Unit 2: ECG Analysis & Delta Waves",
        content: "Delta Waves → PR Intervals → QRS Morphology → Lead Analysis → Localization",
        mediaType: 'image'
      },
      {
        id: 'unit-3-overview',
        title: "Unit 3: Arrhythmia Mechanisms",
        content: "AVRT → AFib Conduction → VF Risk → Emergency Recognition → Clinical Context",
        mediaType: 'image'
      },
      {
        id: 'unit-4-overview',
        title: "Unit 4: Differential Diagnosis",
        content: "WPW vs Bundle Branch Blocks → Preexcitation Syndromes → Pseudo-infarct Patterns",
        mediaType: 'image'
      },
      {
        id: 'unit-5-overview',
        title: "Unit 5: Acute Management & Treatment",
        content: "Emergency Care → Medication Safety → Cardioversion → Treatment Algorithms",
        mediaType: 'image'
      },
      {
        id: 'unit-6-overview',
        title: "Unit 6: Special Considerations",
        content: "Pediatric → Pregnancy → Athletes → Ablation → Long-term Follow-up",
        mediaType: 'image'
      }
    ],
    ...
    summary: "Comprehensive WPW syndrome mastery achieved! You've learned the pathophysiology of accessory pathways, mastered ECG recognition with delta waves, understood dangerous arrhythmia mechanisms, and gained expertise in emergency management. This knowledge prepares you for expert-level WPW care across all clinical scenarios.",
    
    resources: [
      {
        title: "Advanced WPW Pathophysiology and Management",
        url: "https://youtube.com/watch?v=wpw_pathophysiology_advanced",
        type: "video"
      },
      {
        title: "Emergency Management of WPW Arrhythmias",
        url: "https://youtube.com/watch?v=wpw_emergency_protocols",
        type: "video"
      },
      {
        title: "WPW Ablation Techniques and Outcomes",
        url: "https://cardiology.org/wpw-ablation-comprehensive",
        type: "article"
      },
      {
        title: "Pediatric WPW Management Guidelines",
        url: "https://pediatriccardiology.org/wpw-guidelines",
        type: "article"
      }
    ]
  },
