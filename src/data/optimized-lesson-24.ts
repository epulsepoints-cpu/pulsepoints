...
export const optimizedLesson24: Lesson = {
  ...
  content: {
    ...
    slides: [
      ...
      // 🎬 YOUTUBE VIDEO: Understanding Atrial Fibrillation
      {
        id: 'youtube-atrial-fibrillation',
        title: '🎬 Understanding Atrial Fibrillation',
        content: 'Master the most common arrhythmia and its clinical significance',
        type: 'youtube',
        youtubeId: 'Xa-YkT3gJWU',
        videoDuration: 480,
        minimumWatchTime: 384,
        requireFullWatch: false,
        backgroundColor: '#fef2f2',
        textColor: '#991b1b',
        animation: 'fade',
        hint: '🎥 Master complex arrhythmia recognition and management!'
      },

      // 🎬 YOUTUBE VIDEO: A-Fib Clinical Features & ECG Recognition
      {
        id: 'youtube-afib-clinical',
        title: '🎬 A-Fib Clinical Features & ECG Recognition',
        content: 'Clinical diagnosis and ECG interpretation of atrial fibrillation',
        type: 'youtube',
