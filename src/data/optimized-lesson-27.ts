  ...
  content: {
    ...
    slides: [
      ...
      // ===============================================
      {
        ...
        imageAlt: 'AVNRT foundation - SVT at 180 bpm showing typical AVNRT pattern',
        videoUrl: '/lessonvideo/module3/lesson27/avnrt-foundation.mp4',
        audio: {
          narrationUrl: '/audio/module3/lesson27/unit1-intro-narration.mp3',
          autoPlay: false
        },
        highlights: [
...

      {
        ...
        imageAlt: 'AVNRT definition - SVT at 200 bpm demonstrating typical AVNRT features',hint: '📊 #1 SVT worldwide!'
      },

      {
        ...
        imageAlt: 'Normal sinus rhythm showing AV node conduction for comparison with AVNRT',
        videoUrl: '/lessonvideo/module3/lesson27/av-node-anatomy.mp4',tabs: [
          {
...

      {
        ...
        imageAlt: 'AVNRT reentry circuit - SVT at 160 bpm showing reentrant mechanism',
        videoUrl: '/lessonvideo/module3/lesson27/reentry-circuit.mp4',steps: [
          {
            number: 1,
...

      {
        ...
        animation: 'slide',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_180bpm_2.png',
        imageAlt: 'AVNRT foundation quiz - SVT pattern recognition',
        videoUrl: '/lessonvideo/module3/lesson27/unit1-quiz-explanation.mp4',
        audio: {
          narrationUrl: '/audio/module3/lesson27/unit1-quiz-narration.mp3',
          autoPlay: false
        },
      ...
      // ===============================================
      {
        ...
        imageAlt: 'Normal sinus rhythm demonstrating baseline AV conduction',
        videoUrl: '/lessonvideo/module3/lesson27/dual-pathway-physiology.mp4',
        audio: {
          narrationUrl: '/audio/module3/lesson27/unit2-intro-narration.mp3',
          autoPlay: false
        },
        highlights: [
...

      {
        ...
        imageAlt: 'First degree AV block showing slow AV conduction properties',
        videoUrl: '/lessonvideo/module3/lesson27/pathway-properties.mp4',accordionItems: [
          {
...

      {
        ...
        imageAlt: 'PVC showing premature beat that can trigger AVNRT initiation',hint: '🚀 PAC hits the refractory sweet spot!'
      },
      ...
      // ===============================================
      {
        ...
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_180bpm_2.png',
        imageAlt: 'Typical AVNRT at 180 bpm showing classic narrow QRS tachycardia',
        videoUrl: '/lessonvideo/module3/lesson27/ecg-recognition.mp4',highlights: [
          '📈 Regular narrow QRS tachycardia',
...

      {
        ...
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_200bpm_3.png',
        imageAlt: 'Typical AVNRT at 200 bpm showing hidden P waves and regular rhythm',hint: '📈 P waves hide in the QRS!'
      },

      {
        ...
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_160bpm_1.png',
        imageAlt: 'AVNRT P wave analysis at 160 bpm demonstrating P wave timing patterns',
        videoUrl: '/lessonvideo/module3/lesson27/p-wave-analysis.mp4',tabs: [
          {
      ...
      // ===============================================
      {
        ...
        imageAlt: 'Atrial flutter at 150 bpm for comparison with AVNRT differential diagnosis',
        videoUrl: '/lessonvideo/module3/lesson27/differential-diagnosis.mp4',highlights: [
...

      {
        ...
        imageAlt: 'Narrow QRS tachycardia at 165 bpm for AVNRT vs AVRT comparison',
        videoUrl: '/lessonvideo/module3/lesson27/avnrt-vs-avrt.mp4',tabs: [
          {
...

      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_185bpm_4.png',
        imageAlt: 'Narrow QRS tachycardia at 185 bpm showing systematic diagnostic approach',
        videoUrl: '/lessonvideo/module3/lesson27/narrow-qrs-differential.mp4',steps: [
          {
            number: 1,
...

      {
        ...
        textColor: '#be185d',
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_200bpm_1.png',
        imageAlt: 'AVNRT at 200 bpm showing response to vagal maneuvers',
        videoUrl: '/lessonvideo/module3/lesson27/vagal-maneuvers.mp4',accordionItems: [
          {
...

      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/tachycardia_165bpm_8.png',
        imageAlt: 'Chronic AVNRT management with baseline comparison ECG',
        videoUrl: '/lessonvideo/module3/lesson27/chronic-management.mp4',tabs: [
          {
...

      {
        ...
        textColor: '#22543d',
        animation: 'slide',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_175bpm_6.png',
        imageAlt: 'AVNRT clinical management case example at 175 bpm',
        videoUrl: '/lessonvideo/module3/lesson27/unit5-quiz-explanation.mp4',hint: '🧠 Master the treatment approach!',
...

      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/normal_sinus_80bpm_2.png',
        imageAlt: 'Normal baseline ECG in pregnant patient for AVNRT comparison',hint: '🤰 Vagal maneuvers and adenosine are safe!'
      },

      {
        ...
        textColor: '#dc2626',
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_190bpm_3.png',
        imageAlt: 'Emergency department AVNRT case at 190 bpm requiring immediate intervention',
        videoUrl: '/lessonvideo/module3/lesson27/emergency-protocols.mp4',steps: [
          {
            number: 1,
...

      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/ecg/medical_accurate/normal_sinus_75bpm_5.png',
        imageAlt: 'Post-ablation normal sinus rhythm showing excellent long-term outcomes',
        videoUrl: '/lessonvideo/module3/lesson27/long-term-prognosis.mp4',tabs: [
          {
...

      {
        ...
        textColor: '#7c3aed',
        animation: 'slide',
        imageUrl: '/ecg/medical_accurate/supraventricular_tachycardia_180bpm_5.png',
        imageAlt: 'AVNRT special considerations case example at 180 bpm in special population',
        videoUrl: '/lessonvideo/module3/lesson27/unit6-quiz-explanation.mp4',hint: '🧠 Master special population care!',
