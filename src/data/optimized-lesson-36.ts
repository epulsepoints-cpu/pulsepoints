  ...
  content: {
    ...
    slides: [
      // UNIT 1: RHYTHM SPECTRUM (Slides 1-7)
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit1/spectrum-overview.jpg',
      ...
      },
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/junctional_escape_45bpm.png',
        imageAlt: 'Real ECG showing junctional escape rhythm at 45 bpm'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit1/accelerated-patterns.jpg',
        imageAlt: 'Accelerated junctional rhythm patterns'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit1/tachycardia-spectrum.jpg',
        imageAlt: 'Junctional tachycardia spectrum analysis'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit1/premature-contractions.jpg',
        imageAlt: 'Premature junctional contractions pattern'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/av_block_complete.png',
        imageAlt: 'Real ECG showing AV dissociation pattern'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit1/unit1-quiz.jpg',
      ...
      // UNIT 2: DIFFERENTIAL DIAGNOSIS (Slides 8-14)
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit2/differential-overview.jpg',
        imageAlt: 'Differential diagnosis overview for junctional rhythms'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit2/sinus-vs-junctional.jpg',
        imageAlt: 'Sinus vs junctional rhythm comparison'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit2/atrial-vs-junctional.jpg',
        imageAlt: 'Atrial vs junctional tachycardia differentiation'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit2/ventricular-escape.jpg',
        imageAlt: 'Junctional vs ventricular escape comparison'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/av_block_first_degree.png',
        imageAlt: 'Real ECG showing AV block vs junctional rhythm'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit2/diagnostic-algorithm.jpg',
        imageAlt: 'Systematic diagnostic algorithm flowchart'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit2/unit2-quiz.jpg',
      ...
      // UNIT 3: COMPLEX CASES (Slides 15-21)
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit3/complex-overview.jpg',
        imageAlt: 'Complex case analysis overview'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit3/case-bradycardia.jpg',
        imageAlt: 'Complex bradycardia case ECG'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit3/case-tachycardia.jpg',
        imageAlt: 'Narrow QRS tachycardia case analysis'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit3/case-dissociation.jpg',
        imageAlt: 'AV dissociation pattern case'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit3/case-premature-beats.jpg',
        imageAlt: 'Frequent premature junctional contractions case'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit3/case-drug-induced.jpg',
        imageAlt: 'Drug-induced junctional arrhythmia case'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit3/unit3-quiz.jpg',
      ...
      // UNIT 4: CLINICAL DECISION-MAKING (Slides 22-28)
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit4/decision-overview.jpg',
        imageAlt: 'Clinical decision-making overview'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit4/hemodynamic-assessment.jpg',
        imageAlt: 'Hemodynamic assessment protocol'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit4/reversible-causes.jpg',
        imageAlt: 'Reversible causes identification chart'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/av_block_second_degree.png',
        imageAlt: 'Real ECG showing pacing indication scenario'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit4/monitoring-strategies.jpg',
        imageAlt: 'Monitoring strategy selection guide'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit4/treatment-algorithms.jpg',
        imageAlt: 'Evidence-based treatment algorithms'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit4/unit4-quiz.jpg',
      ...
      // UNIT 5: EMERGENCY MANAGEMENT (Slides 29-35)
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit5/emergency-overview.jpg',
        imageAlt: 'Emergency management overview'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit5/immediate-assessment.jpg',
        imageAlt: 'Immediate assessment protocol flowchart'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit5/pharmacologic-interventions.jpg',
        imageAlt: 'Emergency pharmacologic intervention guide'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit5/transcutaneous-pacing.jpg',
        imageAlt: 'Transcutaneous pacing protocol guide'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit5/temporary-pacing.jpg',
        imageAlt: 'Temporary transvenous pacing procedure'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit5/cardioversion-considerations.jpg',
        imageAlt: 'Cardioversion and advanced care protocols'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit5/unit5-quiz.jpg',
      ...
      // UNIT 6: MASTERY ASSESSMENT (Slides 36-42)
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit6/mastery-overview.jpg',
        imageAlt: 'Mastery assessment overview'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit6/recognition-mastery.jpg',
      ...
      },
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit6/differential-mastery.jpg',
        imageAlt: 'Differential diagnosis mastery assessment'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit6/management-mastery.jpg',
        imageAlt: 'Clinical management mastery assessment'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit6/integration-challenge.jpg',
        imageAlt: 'Complex integration challenge scenarios'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit6/competency-validation.jpg',
        imageAlt: 'Competency validation framework'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson36/unit6/unit6-quiz.jpg',
