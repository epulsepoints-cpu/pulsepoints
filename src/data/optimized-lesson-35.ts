...
export const optimizedLesson35: Lesson = {
  ...
  content: {
    ...
    slides: [
      ...
      // 🎬 YOUTUBE VIDEO: Hyperkalemia ECG Changes
      {
        id: 'youtube-hyperkalemia',
        title: '🎬 Hyperkalemia - Progressive ECG Changes and Emergency Recognition',
        content: 'Master hyperkalemia ECG progression from peaked T waves to sine wave pattern. Life-threatening emergency recognition!',
        type: 'youtube',
        youtubeId: 'BuJhAhCivoc',
        videoDuration: 480,
        ...
        textColor: '#dc2626',
        animation: 'fade',
        hint: '⚡ Life-threatening electrolyte emergency!'
      },

      // 🎬 YOUTUBE VIDEO: Electrolyte Abnormalities
      {
        id: 'youtube-electrolyte-abnormalities',
        title: '🎬 Electrolyte Abnormalities - Complete ECG Guide',
        content: 'Comprehensive guide to all electrolyte abnormalities on ECG including potassium, calcium, and magnesium. Essential emergency knowledge!',
        type: 'youtube',
        youtubeId: 'k0J5jCKF5z8',
        videoDuration: 720,
        ...
        textColor: '#dc2626',
        animation: 'fade',
        hint: '⚗️ Complete electrolyte emergency guide!'
      },
      ...
      // UNIT 1: CONDUCTION ANATOMY (Slides 1-7)
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit1/anatomy-overview.jpg',
      ...
      },
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit1/sa-node-structure.jpg',
        imageAlt: 'Detailed SA node anatomy and connections'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit1/atrial-conduction.jpg',
        imageAlt: 'Atrial conduction pathway diagram'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/av_block_complete.png',
        imageAlt: 'Real ECG showing AV block pattern'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit1/his-purkinje-system.jpg',
        imageAlt: 'His-Purkinje system detailed anatomy'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit1/ventricular-activation.jpg',
        imageAlt: 'Ventricular activation sequence diagram'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit1/unit1-quiz.jpg',
      ...
      // UNIT 2: NORMAL PHYSIOLOGY (Slides 8-14)
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit2/physiology-overview.jpg',
      ...
      },
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit2/conduction-timing.jpg',
        imageAlt: 'Normal conduction timing diagram'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit2/av-node-function.jpg',
        imageAlt: 'AV node physiologic function illustration'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit2/action-potentials.jpg',
        imageAlt: 'Cellular action potential comparisons'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit2/conduction-velocity.jpg',
        imageAlt: 'Conduction velocity variations diagram'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit2/refractory-periods.jpg',
        imageAlt: 'Refractory period concepts illustration'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit2/unit2-quiz.jpg',
      ...
      // UNIT 3: BLOCK CLASSIFICATION (Slides 15-21)
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit3/classification-overview.jpg',
        imageAlt: 'AV block classification overview'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/av_block_first_degree.png',
        imageAlt: 'Real ECG showing first degree AV block'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit3/second-degree-overview.jpg',
        imageAlt: 'Second degree AV block overview patterns'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/av_block_second_degree.png',
        imageAlt: 'Real ECG showing Mobitz Type I pattern'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit3/mobitz-type-2.jpg',
        imageAlt: 'Mobitz Type II pattern characteristics'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit3/third-degree-complete.jpg',
        imageAlt: 'Complete AV block with escape rhythm'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit3/unit3-quiz.jpg',
      ...
      // UNIT 4: PATHOPHYSIOLOGY (Slides 22-28)
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit4/pathophysiology-overview.jpg',
        imageAlt: 'AV block pathophysiology overview'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit4/ischemic-mechanisms.jpg',
        imageAlt: 'Ischemic AV block mechanisms'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit4/degenerative-processes.jpg',
        imageAlt: 'Degenerative conduction system disease'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit4/inflammatory-causes.jpg',
        imageAlt: 'Inflammatory causes of AV block'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit4/drug-induced-blocks.jpg',
        imageAlt: 'Drug-induced AV block mechanisms'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit4/congenital-disorders.jpg',
        imageAlt: 'Congenital AV conduction disorders'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit4/unit4-quiz.jpg',
      ...
      // UNIT 5: CLINICAL SIGNIFICANCE (Slides 29-35)
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit5/clinical-overview.jpg',
        imageAlt: 'Clinical significance overview'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit5/hemodynamic-effects.jpg',
        imageAlt: 'Hemodynamic effects of AV blocks'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit5/symptom-spectrum.jpg',
        imageAlt: 'Clinical symptom spectrum chart'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit5/prognostic-factors.jpg',
        imageAlt: 'Prognostic factors assessment'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit5/risk-stratification.jpg',
        imageAlt: 'Risk stratification approach'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit5/quality-of-life.jpg',
        imageAlt: 'Quality of life impact assessment'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit5/unit5-quiz.jpg',
      ...
      // UNIT 6: DIAGNOSTIC APPROACH (Slides 36-42)
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit6/diagnostic-overview.jpg',
        imageAlt: 'Diagnostic approach overview'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit6/ecg-analysis-steps.jpg',
        imageAlt: 'Systematic ECG analysis steps'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit6/measurement-techniques.jpg',
        imageAlt: 'ECG measurement techniques'},
      {
        ...
        textColor: '#1e40af',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit6/holter-monitoring.jpg',
        imageAlt: 'Holter monitoring applications'},
      {
        ...
        textColor: '#22543d',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit6/exercise-testing.jpg',
        imageAlt: 'Exercise testing for AV blocks'},
      {
        ...
        textColor: '#7c3aed',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit6/electrophysiology-study.jpg',
        imageAlt: 'Electrophysiology study techniques'},
      {
        ...
        textColor: '#ea580c',
        animation: 'fade',
        imageUrl: '/lessonimages/module4/lesson35/unit6/unit6-quiz.jpg',
