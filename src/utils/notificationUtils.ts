...
export const getDefaultActionUrl = (type: string, notificationData?: any): string => {
  switch (type) {
    case 'lesson':
...
export const createNotificationWithActionUrl = (
  userId: string,
  type: string,
  title: string,
  body: string,
...
export const fixNotificationActionUrl = (notification: any) => {
