// This file ensures Firebase configuration consistency across the application
// Export all Firebase configuration values needed by the app
...
const firebaseConfig = {
  ...
  storageBucket: "ecgkid-pulsepoint.appspot.com",
