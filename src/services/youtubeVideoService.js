 ...
 */
export const convertYouTubeTaskToTaskData = (youtubeTask, eventId, dayNumber, taskIndex) => {
    return {
        id: `${eventId}-day-${dayNumber}-task-${taskIndex + 1}`,
        title: youtubeTask.videoTitle,
        description: youtubeTask.videoDescription,
        type: 'interactive-video',
        difficulty: youtubeTask.difficulty,
 ...
 */
const generateQuizPointsForVideo = (youtubeTask) => {
    const baseQuestions = {
        arrhythmia: [
            {
 ...
 */
export const generateVideoTasksForDay = (eventId, dayNumber, targetDifficulty, count = 2) => {
    ...
    return selectedVideos.map((video, index) => convertYouTubeTaskToTaskData(video, eventId, dayNumber, index));
};
/**
 * Generate a mixed set of video tasks for variety
 */
export const generateMixedVideoTasks = (eventId, dayNumber, count = 5) => {
    ...
    return mixedVideos.slice(0, count).map((video, index) => convertYouTubeTaskToTaskData(video, eventId, dayNumber, index));
};
export default {
