 ...
 */
export const handleLessonCompletion = async (data) => {
 ...
 */
const updateUserDocument = async (userId, xp, gems, perfect) => {
 ...
 */
const updateUserProgressStats = async (userId, score, timeSpent, perfect) => {
    ...
    if (!statsDoc.exists()) {
        ...
        const newAverageScore = Math.round(((currentData.averageScore || 0) * (currentData.totalLessons || 0) + score) / newTotalLessons);
 ...
 */
const updateModuleProgress = async (userId, moduleId, score, timeSpent) => {
    ...
    if (!progressDoc.exists()) {
        ...
        const newAverageScore = Math.round(((currentData.averageScore || 0) * (currentData.completedLessons || 0) + score) / newCompletedLessons);
 ...
 */
const updateUserLearningProfile = async (userId, score, timeSpent) => {
    ...
    if (!profileDoc.exists()) {
        ...
        const newAverageAccuracy = Math.round(((currentData.averageAccuracy || 0) * (currentData.totalLessonsCompleted || 0) + score) / newTotalLessons);
